  ...
  return (
    <div className="flex justify-between items-center text-3xl font-extrabold w-full font-mono bg-zinc-100 p-4">
      ...
      <div className="flex space-x-12 items-center">
        ...
        <Link to="/makeitreal">
          <button className="bg-yellow-400 hover:bg-yellow-500 text-black text-2xl px-6 py-2 rounded-full shadow-lg transition duration-300 mb-3">HAZLO REAL</button>
        </Link>
      </div>
    </div>
  );
